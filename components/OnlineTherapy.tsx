            ...
            <div className="max-w-7xl mx-auto px-6 sm:px-10">
                <div className="flex flex-col lg:flex-row lg:items-center gap-10 lg:gap-24">
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        transition={{ duration: 0.8 }}
                        className="hidden lg:flex flex-1 w-full justify-center"
                    >
                        {/* Container da Imagem para computador */}
                        <div className="relative w-full aspect-[4/3] rounded-[2.5rem] overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.08)] border-[8px] border-white/40 bg-white/10">
                            <Image
                                src="/foto-online.png"
                                alt="Notebook e livro ilustrando o atendimento online"
                                fill
